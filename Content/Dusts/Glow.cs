...
namespace DartGunsPlus.Content.Dusts
{
    ...
    {
        public override string Texture => "DartGunsPlus/Content/Projectiles/Glow";
        ...
        public override void OnSpawn(Dust dust)
        {
            ...
            dust.shader = new Terraria.Graphics.Shaders.ArmorShaderData(new Ref<Effect>(ModContent.Request<Effect>("DartGunsPlus/Content/Effects/GlowingDust", 
                ReLogic.Content.AssetRequestMode.ImmediateLoad).Value), "GlowingDustPass");
            dust.scale *= 0.75f;
        }
