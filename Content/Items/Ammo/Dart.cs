...
public class DartProjectile : ModProjectile
{
    ...
    ///     ticks.
    /// </summary>
    public virtual int GravityDelay => 12;
    ...
    ///     this propery).
    /// </summary>
    public virtual float GravityDecreaseX => 0.04f;
