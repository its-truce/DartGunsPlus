...
public class StyxRune : ModProjectile
{
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Main.EntitySpriteDraw(texture2, drawPos, null, new Color(255, 255, 255, 0) * Projectile.Opacity, MathHelper.ToRadians(Projectile.ai[2]) / 2,
            texture2.Size() / 2, Projectile.scale * 1.3f, SpriteEffects.None);
