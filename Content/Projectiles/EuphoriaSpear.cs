...
public class EuphoriaSpear : ModProjectile
{
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Main.EntitySpriteDraw(texture, drawPos, null, color, 0, drawOrigin, Projectile.scale * 0.35f, SpriteEffects.None);
    ...
    public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
    {
        ...
        Projectile.NewProjectile(Projectile.GetSource_Death(), target.Center + new Vector2(0, 30), Vector2.Zero,
            ModContent.ProjectileType<EuphoriaCircle>(), Projectile.damage * 2, 6, Projectile.owner, target.whoAmI, 1);
    }
