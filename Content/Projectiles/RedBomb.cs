...
public class RedBomb : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        else
        {
            ...
            {
                var dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Smoke, 0f, 0f, 100);
    ...
    public override void OnKill(int timeLeft)
    {
        ...
        for (var g = 0; g < 2; g++)
        {
            ...
            var gore = Gore.NewGoreDirect(Projectile.GetSource_FromThis(), goreSpawnPosition, default, Main.rand.Next(61, 64));
            gore.scale = 1.5f;
