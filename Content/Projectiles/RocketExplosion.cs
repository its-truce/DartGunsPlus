...
public class RocketExplosion : ModProjectile
{
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Main.EntitySpriteDraw(texture2, drawPos, null, Color.Lerp(new Color(192, 16, 42, 0), color, 0.15f),
    ...
    public override void PostDraw(Color lightColor)
    {
        ...
        Color color1 = Color.Lerp(new Color(206, 65, 32, 0), color, Projectile.ai[0]);
        Color color2 = Color.Lerp(Color.OrangeRed, color, 0.3f);
        Color color3 = Color.Lerp(Color.Orange, color, 0.7f);
        color1.A = 0;
        color2.A = 0;
        color3.A = 0;
