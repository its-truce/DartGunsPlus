...
public class EuphoriaUIState : ModUIState
{
    ...
    public override void OnInitialize()
    {
        ...
        _textureBar ??= ModContent.Request<Texture2D>("DartGunsPlus/Content/UI/EuphoriaFill", AssetRequestMode.ImmediateLoad).Value;
    ...
    public override void Draw(SpriteBatch spriteBatch)
    {
        ...
        if (!player.dead && player.HeldItem.ModItem is TrueEuphoria)
        {
            ...
            rectangle.Width = (int)(EuphoriaPlayer.EuphoriaCurrent / Segment);
