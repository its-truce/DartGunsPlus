...
internal class LaserResourceBar : UIState
{
    ...
    public override void OnInitialize()
    {
        ...
        _barFrame = new UIImage(ModContent.Request<Texture2D>("DartGunsPlus/Content/UI/LaserFrame")); // Frame of our resource bar
        ...
        _gradientA = Color.LightPink;
        _gradientB = Color.HotPink;
    ...
    {
        if (Main.LocalPlayer.HeldItem.ModItem is not LaserTherapy)
            return;
    ...
    protected override void DrawSelf(SpriteBatch spriteBatch)
    {
        ...
        LaserPlayer modPlayer = Main.LocalPlayer.GetModPlayer<LaserPlayer>();

        float quotient = (float)modPlayer.LaserCurrent / modPlayer.LaserMax2;
...
internal class LaserUISystem : ModSystem
{
    private LaserResourceBar _laserBar;
    private UserInterface _laserResourceUserInterface;

    public override void Load()
    {
        _laserBar = new LaserResourceBar();
        _laserResourceUserInterface = new UserInterface();
        _laserResourceUserInterface.SetState(_laserBar);
    }

    public override void UpdateUI(GameTime gameTime)
    {
        _laserResourceUserInterface?.Update(gameTime);
    }
    ...
    public override void ModifyInterfaceLayers(List<GameInterfaceLayer> layers)
    {
        ...
        if (resourceBarIndex != -1)
            layers.Insert(resourceBarIndex, new LegacyGameInterfaceLayer(
                "DartGunsPlus: Laser Bar",
                delegate
                {
                    _laserResourceUserInterface.Draw(Main.spriteBatch, new GameTime());
                    return true;
                },
