...
public class MartianUIState : ModUIState
{
    private static MartianPlayer MartianPlayer => Main.LocalPlayer.GetModPlayer<MartianPlayer>();
    private static float Segment => MartianPlayer.MartianMax2 / 38f; // Player max flail charge divided by the flail bar texture width
    ...
    public override void Draw(SpriteBatch spriteBatch)
    {
        ...
        if (!player.dead && player.HeldItem.ModItem is MartianMarksman)
        {
            spriteBatch.End();
            ...
            rectangle.Width = (int)(MartianPlayer.MartianCurrent / Segment);
